...
function M.init()
	...
	local theme = lush(function(fn)
		...
		return {
			...
			-- LP: Oil looks better when the directories are blue
			...
			-- Gitsigns
			-- LP TODO: I don't really like this green for the add lines...I'd like a slightly more vibrant green
			-- diffAdded({ fg = color.green, bg = color.bg }),
			diffAdded({ fg = color.green.lighten(20).rotate(20), bg = color.bg }),
			...
			-- LP: Change this? make it stand out more?
			-- CursorLineNr({ fg = LineNr.fg.lighten(15), bold = true }), -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
			CursorLineNr({ fg = color.yellow, bold = true }), -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
